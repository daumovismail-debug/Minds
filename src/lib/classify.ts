...
const RU_LIST_START =
  /^(покажи|покаж|выведи|выдай|вывод|список|открой|какие\s+у\s+меня|сколько\s+у\s+меня|что\s+у\s+меня|где\s+мои|мои\s+(задач|мысл))/;
